...
export const searchEntitiesByCollectionGroup = createAction(
  '[Permission] Search Permissions By Collection Group',
  props<{
    searchParams: SearchParam[];
  }>()
);

export const searchEntitiesByCollectionGroupSuccess = createAction(
  '[Permission] Search Permissions By Collection Group Success',
  props<{ permissions: PermissionEntity[] }>()
);

export const searchEntitiesByCollectionGroupFail = createAction(
  '[[Permission] Search Permissions By Collection Group Fail',
  props<{ error: string }>()
);
