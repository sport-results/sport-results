...
const sportCategoryRuleReducer = createReducer(
  ...
  on(
    ...
    (state, { sportCategoryRule }) =>
      sportCategoryRuleAdapter.addOne(sportCategoryRule, {
        ...state,
        loading: false,
      })
  ),
  ...
  on(
    sportCategoryRuleActions.changeNewEntityButtonEnabled,
    (state, { enabled }) => ({
      ...state,
  ...
  on(
    ...
    (state, { sportCategoryRule }) => {
      if (sportCategoryRule) {
        return sportCategoryRuleAdapter.upsertOne(sportCategoryRule, {
          ...state,
          loading: false,
        });
      } else {
  ...
  on(
    sportCategoryRuleActions.listEntitiesSuccess,
    sportCategoryRuleActions.listGroupEntitiesSuccess,
    (state, { sportCategoryRules }) =>
  ...
  on(
    sportCategoryRuleActions.listEntitiesFail,
    sportCategoryRuleActions.listGroupEntitiesFail,
    (state, { error }) => ({
      ...state,
      error,
      loading: false,
  ...
  on(sportCategoryRuleActions.updateEntityFail, (state, { error }) => ({
    ...state,
    error,
  }))
);
