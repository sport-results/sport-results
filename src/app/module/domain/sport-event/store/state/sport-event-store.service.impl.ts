...
export class SportEventStoreServiceImpl extends SportEventStoreService {
    public constructor(private store: Store<fromSportEvent.SportEventPartialState>) {
        super();
    }
    ...
    public dispatchListEntitiesAction(
        ...
        this.store.dispatch(sportEventActions.listEntities({
            subCollectionPath,
    ...
    public dispatchUpdateEntityAction(
        ...
        this.store.dispatch(sportEventActions.updateEntity({
            sportEvent,
            subCollectionPath
        }));
    }
    ...
    public selectNewEntityButtonEnabled$(): Observable<boolean> {
        return this.store.pipe(select(SportEventSelectors.isNewEntityButtonEnabled));
    }
