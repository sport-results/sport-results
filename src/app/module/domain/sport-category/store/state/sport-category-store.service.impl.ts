...
export class SportCategoryStoreServiceImpl extends SportCategoryStoreService {
  public constructor(
    private store: Store<fromSportCategory.SportCategoryPartialState>
  ) {
    super();
  }
  ...
  public dispatchListEntitiesAction(
    ...
    this.store.dispatch(
      sportCategoryActions.listEntities({
        subCollectionPath,
  ...
  public override selectEntityById$(
    ...
    return this.store.pipe(
      select(SportCategorySelectors.getEntityById(entityId))
    );
  }

  public selectNewEntityButtonEnabled$(): Observable<boolean> {
    return this.store.pipe(
      select(SportCategorySelectors.isNewEntityButtonEnabled)
    );
  }
