...
export class SportResultStoreServiceImpl extends SportResultStoreService {
  public constructor(
    private store: Store<fromSportResult.SportResultPartialState>
  ) {
    super();
  }
  ...
  public dispatchAddEntityAction(
    ...
    this.store.dispatch(
      sportResultActions.addEntity({ sportResult, subCollectionPath })
    );
  }
  ...
  public dispatchListEntitiesAction(
    ...
    this.store.dispatch(
      sportResultActions.listEntities({
        subCollectionPath,
  ...
  public dispatchSelectEntityAction(
    sportResult: SportResultEntity | null
  ): void {
  ...
  public dispatchUpdateEntityAction(
    ...
    this.store.dispatch(
      sportResultActions.updateEntity({
        sportResult,
        subCollectionPath,
      })
    );
  ...
  public selectEntity$(uid: string): Observable<SportResultEntity | undefined> {
  ...
  public override selectEntityById$(
    ...
    return this.store.pipe(
      select(SportResultSelectors.getEntityById(entityId))
    );
  }

  public selectEntityBySportEventId$(
    sportEventId: string
  ): Observable<SportResultEntity | undefined> {
    return this.store.pipe(
      select(SportResultSelectors.getEntityBySportEventId(sportEventId))
    );
  }

  public selectNewEntityButtonEnabled$(): Observable<boolean> {
    return this.store.pipe(
      select(SportResultSelectors.isNewEntityButtonEnabled)
    );
  }
