...
export class NetworkPlayerEffects {
    ...
    addEntity$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap((action) =>
                this.networkPlayerEffectService.addEntity$(
                    action.networkPlayer,
                    `${NETWORK_PLAYER_FEATURE_KEY}/${action.parentEntityId}`
                ).pipe(
                    map((entity) =>
    ...
    updateEntity$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap((action) =>
                this.networkPlayerEffectService.updateEntity$(
                    action.networkPlayer,
                    action.subCollectionPath
                ).pipe(
                    map((entity) =>
