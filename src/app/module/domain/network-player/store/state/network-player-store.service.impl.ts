...
export class NetworkPlayerStoreServiceImpl extends NetworkPlayerStoreService {
    public constructor(private store: Store<fromNetworkPlayer.NetworkPlayerPartialState>) {
        super();
    }
    ...
    public dispatchAddEntityAction(
        ...
        this.store.dispatch(networkPlayerActions.addEntity({ networkPlayer,  parentEntityId }));
    }
    ...
    public dispatchListEntitiesAction(
        ...
        this.store.dispatch(networkPlayerActions.listEntities({
            subCollectionPath,
    ...
    public dispatchSelectEntityAction(networkPlayer: NetworkPlayerEntity | null): void {
    ...
    public dispatchUpdateEntityAction(
        ...
        this.store.dispatch(networkPlayerActions.updateEntity({
            networkPlayer,
            subCollectionPath
        }));
    }
    ...
    public override selectEntityById$(
        ...
        return this.store.pipe(select(NetworkPlayerSelectors.getEntityById(entityId)));
    }

    public selectNewEntityButtonEnabled$(): Observable<boolean> {
        return this.store.pipe(select(NetworkPlayerSelectors.isNewEntityButtonEnabled));
    }
